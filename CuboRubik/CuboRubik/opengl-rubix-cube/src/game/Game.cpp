...
void init() {
    // shader program
    GLuint program = Angel::InitShader("opengl-rubix-cube/glsl/vshader.glsl",
                                       "opengl-rubix-cube/glsl/fshader.glsl");
...
void game::handbook() {
	std::cout << "**** Premendo i tasti da 1 a 6 \x8a possibile selezionare una delle facce                 ****\n"; 
	std::cout << "**** Premendo il tasto w \x8a possibile ruotare il cubo verso l alto                      ****\n";
	std::cout << "**** Premendo il tasto s \x8a possibile ruotare il cubo verso il basso                    ****\n";
	std::cout << "**** Premendo il tasto q \x8a possibile ruotare il cubo lateralmente in senso orario      ****\n";
	std::cout << "**** Premendo il tasto e \x8a possibile ruotare il cubo lateralmente in senso antiorario  ****\n";
	std::cout << "**** Premendo il tasto d \x8a possibile ruotare il cubo in senso antiorario               ****\n";
	std::cout << "**** Premendo il tasto a \x8a possibile ruotare il cubo in senso orario                   ****\n";
	std::cout << "**** Premendo il tasto z \x8a possibile ruotare la faccia selezionata in senso orario     ****\n";
	std::cout << "**** Premendo il tasto x \x8a possibile ruotare il faccia selezionata in senso antiorario ****\n";
	std::cout << "**** Premendo il tasto A \x8a possibile ruotare il cubo verso l alto                      ****\n";
	std::cout << "**** Premendo il tasto D \x8a possibile ruotare il cubo verso l alto                      ****\n";
