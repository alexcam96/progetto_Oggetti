...
SmallCube::SmallCube(glm::vec3 p, game::Mesh *flat, game::Mesh *rubix) {
    ...
    for (GLint i = 0; i < 6; i++) {
		...
		//*********** MARTI **********
		//dichiarare vet e id su rubixCube e passare come argomenti su SmallCube
		//vet[id] = id;
		//id++;
		//*********** END ************
        // position
...
CubeFace::CubeFace(bool f, game::Mesh *flat, game::Mesh *rubix, glm::vec3 p) {
	...
	int app;
	//inserisce i colori su ogni piccolo quadratino di uno small cube
